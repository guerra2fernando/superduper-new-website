...
export default function Customers() {
  ...
  const items = [
    {
      img: CustomerImg01,
      quote: "I love SuperDuper, is super easy to use with top notch features. My favourites are the affiliates and the lovely login box that converts like magic.",
      name: 'Mike Smets',
      twitter: {
        handle: '@MikeSmets',
        link: '#0'
